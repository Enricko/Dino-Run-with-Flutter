...
class EnemyManager extends Component with HasGameRef<MyGame> {
  ...
  void spawnRandomEnemy() {
    ...
    if (enemyData.canFly) {
      final newHeight = _random.nextDouble() * 1.2 * enemyData.textureSize.y;
  ...
  void onMount() {
    ...
    if (_data.isEmpty) {
      ...
      _data.addAll([
        // EnemyData(
        //   image: gameRef.images.fromCache('enemies/AngryPig/Walk (36x30).png'),
        //   nFrames: 16,
        //   stepTime: 0.1,
        ...
        // ),
        EnemyData(
          image: gameRef.images.fromCache('enemies/Bat/Flying (46x30).png'),
          nFrames: 7,
          stepTime: 0.1,
        ...
        EnemyData(
          image: gameRef.images.fromCache('enemies/Rino/Run (52x34).png'),
          nFrames: 6,
          stepTime: 0.09,
